...
@section('content')
    ...
    <div class="panel panel-default" style="margin-left: 1%; background-color: #ffffff; border: 1px solid #e7e7e7; color: #838383; width: 90%; margin-left: 5%;
        ...
        <div class="panel-body" style="width:20%; min-height: 2000px; border: 2px solid #e7e7e7; float: left; background-color: #dcf3dc " >

           <div style="height: 55px; width: 100%; border-bottom: 2px solid #e7e7e7;">
              <label style="text-align: center; width: 100%;"><a href="{{ route('blog') }}">  Todos os Posts</a> </label>
           </div>
        ...
        <div class="panel-body" style="width:80%; min-height: 2000px;float: right;  border: 2px solid #e7e7e7; background: white;" >
